<template>
  <el-card shadow="always">
    ...
    <div class="buttons-block">
      ...
      v-permission="'system.whitelist.new'"
    ...
    <el-table :data="tableData" style="width: 100%" stripe border show-overflow-tooltip>
      ...
      <el-table-column :label="t('OperationsLabel')" min-width="120">
        <template #default="{ row }">
          ...
          <el-button link type="primary" size="default" @click="handleEdit(row)" v-permission="'system.whitelist.edit'">{{ t('EditLabel') }}</el-button>
          <el-button link type="primary" size="default" @click="handleDelete(row.id)" v-permission="'system.whitelist.delete'">{{ t('DeleteLabel') }}</el-button>
        </template>
      </el-table-column>
    </el-table>
